...
/**
 * find_in_path - looks for a command in each directory specified in the PATH environment variable
 * Return: Pointer to string containing the full path if it is found or NULL if it is not
*/
